...
const SignUp = ({navigation}) => {
	...
	return (
		...
		<ScrollView>
			...
			<TextInput placeholder="Full Name" style={styles.textInput} autoCapitalize="none" onChangeText={(val) => textInputChange(val)}/>
		{
			...
			<TextInput keyboardType='number-pad' placeholder="Mobile Number" style={styles.textInput} autoCapitalize="none"
